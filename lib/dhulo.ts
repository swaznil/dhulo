...
export type DhuloTheme = {
  ...
  caption: string;
  mode: 'dark' | 'light';
  backgroundStyle: 'void' | 'mist' | 'paper' | 'garden' | 'signal';
  background: string;
  surface: string;
  elevated: string;
  text: string;
...
export const DHULO_THEMES: Record<ThemeId, DhuloTheme> = {
  obsidian: {
    id: 'obsidian',
    name: 'Obsidian',
    caption: 'AMOLED black, glass, quiet focus',
    mode: 'dark',
  ...
  aurora: {
    id: 'aurora',
    name: 'Aurora',
    caption: 'Midnight glow, electric edges',
    mode: 'dark',
  ...
  daylight: {
    id: 'daylight',
    name: 'Daylight',
    caption: 'Warm white, brass edges',
    mode: 'light',
    backgroundStyle: 'mist',
    background: '#f8f4ec',
    surface: '#fffdf8',
  ...
  archive: {
    id: 'archive',
    name: 'Archive',
    caption: 'Ledger green, clean daylight',
    mode: 'light',
    backgroundStyle: 'garden',
    background: '#edf5ee',
    surface: '#fbfff8',
  ...
  signal: {
    id: 'signal',
    name: 'Signal',
    caption: 'Ink blue, high-contrast glow',
    mode: 'dark',
    backgroundStyle: 'signal',
    background: '#08121e',
    surface: '#111f30',
